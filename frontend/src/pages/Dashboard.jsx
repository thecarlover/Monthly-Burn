...
import { getExpenses, getProfile } from '../services/api';
        ...
        <div className={`space-y-8 pb-12 min-h-screen transition-all duration-1000 ${pulseTheme} border-x-8 border-transparent`}>
            ...
            <div className={`relative z-10 space-y-6 md:space-y-8 ${pulseGlow} rounded-[2rem] md:rounded-[3rem] p-3 md:p-4`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                    ...
                    >
                        <div className="relative z-10">
                            <h4 className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-2">Saving Streak</h4>
                            ...
                            <p className="text-slate-400 mt-4 text-xs md:text-sm font-medium">Keep your burn score below 50 to grow your streak! 🎖️</p>
                        </div>
